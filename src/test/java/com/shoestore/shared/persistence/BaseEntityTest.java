...
class BaseEntityTest {
  ...
  @Test
  void shouldConsiderEntitiesWithSameIdentifierEqual() throws Exception {
  ...
  @Test
  void shouldReportEntityAsPersistedWhenIdentifierExists() throws Exception {
  ...
  private void setIdentifier(BaseEntity entity, UUID identifier) throws Exception {
