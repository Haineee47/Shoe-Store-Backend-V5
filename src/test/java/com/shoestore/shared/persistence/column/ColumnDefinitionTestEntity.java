...
public class ColumnDefinitionTestEntity extends AuditableEntity {

  @Column(name = "required_code", nullable = false, length = 100)
  private String requiredCode;

  @Column(name = "optional_label", length = 150)
