...
class EntityMappingConventionTest {
  ...
  void shouldDeclareExplicitEntityAndTableMapping() {
    Entity entity = AuditingTestEntity.class.getAnnotation(Entity.class);

    Table table = AuditingTestEntity.class.getAnnotation(Table.class);

    assertThat(entity).isNotNull();
    assertThat(table).isNotNull();
    assertThat(table.name()).isEqualTo("auditing_test_entity");
  }
  ...
  @Test
  void shouldMapCreatedTimestampAsImmutableInstant() throws Exception {
  ...
  @Test
  void shouldMapUpdatedTimestampAsInstant() throws Exception {
  ...
  @Test
  void shouldDefineExplicitLengthForBoundedString() throws Exception {

    Field nameField = AuditingTestEntity.class.getDeclaredField("name");
