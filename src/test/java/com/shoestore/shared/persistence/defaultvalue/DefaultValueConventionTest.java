...
class DefaultValueConventionTest {
    ...
    void applicationOwnedDefaultsShouldBeInitializedInJava() {
        DefaultValueFixtureEntity entity =
                new DefaultValueFixtureEntity("fixture");
    ...
    @Test
    void databaseOwnedDefaultShouldNotBeInsertableOrUpdatable()
            throws NoSuchFieldException {

        Field field = DefaultValueFixtureEntity.class
                .getDeclaredField("databaseCreatedAt");
    ...
    @Test
    void applicationOwnedDefaultsShouldRemainInsertable()
            throws NoSuchFieldException {
    ...
    private static void assertApplicationOwnedColumn(
            String fieldName
    ) throws NoSuchFieldException {
