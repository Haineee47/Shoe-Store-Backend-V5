...
class RelationshipMappingConventionTest {
    ...
    @Test
    void shouldMapChildToParentAsLazyManyToOne()
            throws Exception {

        Field parentField =
                RelationshipChildTestEntity.class
                        .getDeclaredField("parent");

        ManyToOne manyToOne =
                parentField.getAnnotation(ManyToOne.class);
    ...
    @Test
    void shouldDefineExplicitJoinColumnAndForeignKey()
            throws Exception {
        ...
        JoinColumn joinColumn =
                parentField.getAnnotation(JoinColumn.class);
    ...
    @Test
    void shouldMapParentCollectionAsLazyInverseSide()
            throws Exception {

        Field childrenField =
                RelationshipParentTestEntity.class
                        .getDeclaredField("children");

        OneToMany oneToMany =
                childrenField.getAnnotation(OneToMany.class);
    ...
    @Test
    void shouldLimitCascadeToPersistAndMerge()
            throws Exception {
