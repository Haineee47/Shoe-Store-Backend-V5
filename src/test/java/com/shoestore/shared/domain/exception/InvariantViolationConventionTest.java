...
class InvariantViolationConventionTest {
    ...
    void shouldRejectConfirmationWhenOrderHasNoItems() {
        ...
        assertThat(exception.errorCode())
                .isSameAs(TestOrderErrorCode.ORDER_HAS_NO_ITEMS);
    ...
    void shouldPreserveStateWhenConfirmationInvariantFails() {
        ...
        assertThat(order.totalItemQuantity())
                .isZero();
    }
    ...
    void shouldRejectMutationAfterConfirmation() {
        ...
        assertThat(exception).isNotNull();
        assertThat(exception.errorCode())
                .isSameAs(TestOrderErrorCode.ORDER_ALREADY_CONFIRMED);
        assertThat(exception)
                .hasMessage("A confirmed order cannot be modified");
    }
