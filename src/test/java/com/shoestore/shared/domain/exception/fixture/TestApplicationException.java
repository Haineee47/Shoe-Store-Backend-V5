...
/**
 * Test-only application exception produced after translating a known domain rejection at the
...
public final class TestApplicationException extends RuntimeException {
  ...
  public TestApplicationException(
      TestApplicationErrorCode errorCode, String message, TestDomainException cause) {
