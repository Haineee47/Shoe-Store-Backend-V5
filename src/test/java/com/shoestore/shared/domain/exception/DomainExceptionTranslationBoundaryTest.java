...
class DomainExceptionTranslationBoundaryTest {
    ...
    void shouldTranslateConfirmationInvariantViolation() {
        ...
        TestApplicationException applicationException =
                translator.translate(domainException);
        ...
        assertThat(applicationException)
                .hasMessage("Order confirmation was rejected");
    }
    ...
    void shouldTranslateCancellationRejection() {
        ...
        assertThat(applicationException)
                .hasMessage("Order cancellation was rejected");
    }
    ...
    void shouldPreserveOriginalDomainExceptionAsCause() {
        ...
        assertThat(applicationException.getCause())
                .isSameAs(domainException);
    }
    ...
    void shouldPreserveOriginalDomainErrorCodeThroughCause() {
        ...
        TestDomainException cause =
                (TestDomainException) applicationException.getCause();

        assertThat(cause.errorCode())
                .isSameAs(
                        TestOrderErrorCode.ORDER_CANNOT_BE_CANCELLED
                );
    }
    ...
    void shouldNotExposeRawDomainMessageAsApplicationMessage() {
        TestDomainException domainException =
                new TestDomainException(
                        TestOrderErrorCode.ORDER_HAS_NO_ITEMS,
                        "Internal diagnostic domain message"
                );
        ...
        assertThat(applicationException.getMessage())
                .isEqualTo("Order confirmation was rejected");

        assertThat(applicationException.getMessage())
                .isNotEqualTo(domainException.getMessage());
    }
    ...
    void shouldFailFastWhenApplicationMappingIsNotDefined() {
        ...
        assertThatIllegalStateException()
                ...
                .withMessageContaining(
                        "No application mapping defined"
                )
                .withMessageContaining(
