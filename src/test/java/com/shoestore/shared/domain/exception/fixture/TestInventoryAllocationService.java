...
/**
 * Test-only stateless domain service used to verify business-rejection conventions across multiple
 * domain values.
 *
 * <p>The service has no repository, framework, persistence, clock, random generator, logger, or
 * mutable internal state.
 */
public final class TestInventoryAllocationService {

  public TestInventoryAllocation allocate(
      TestAllocationRequest request, TestInventoryAvailability inventory) {
