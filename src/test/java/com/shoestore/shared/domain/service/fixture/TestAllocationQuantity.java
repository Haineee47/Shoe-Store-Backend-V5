 ...
 *
 * <p>
 * Zero is valid because an allocation result, remaining quantity or
 * unfulfilled quantity may legitimately be zero.
 * </p>
 */
public record TestAllocationQuantity(int value) {
    ...
    public TestAllocationQuantity subtract(
            TestAllocationQuantity amount
    ) {
        if (amount == null) {
