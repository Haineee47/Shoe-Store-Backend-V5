...
class ValueObjectDefensiveCopyTest {
    ...
    void shouldNotExposeMutableCollection() {
        var tags = new TestTags(
                List.of("running", "sport")
        );

        assertThatThrownBy(
                () -> tags.values().add("sale")
        )
                .isInstanceOf(
    ...
    void shouldUseCollectionContentsForEquality() {
        var first = new TestTags(
                List.of("running", "sport")
        );

        var second = new TestTags(
                List.of("running", "sport")
        );
    ...
    void sourceMutationShouldNotChangeHashCode() {
        ...
        assertThat(tags.hashCode())
                .isEqualTo(originalHashCode);
    }
}
