...
class AggregateConstructionConventionTest {
    ...
    void shouldDeclareJpaConstructorAsProtected() {
        Constructor<?> constructor =
                Arrays.stream(TestAggregateRoot.class.getDeclaredConstructors())
                        ...
                        .orElseThrow(() ->
                                new AssertionError(
                                        "JPA constructor was not declared"
                                )
                        );
    ...
    void shouldNotDeclarePublicConstructors() {
        Constructor<?>[] publicConstructors =
                TestAggregateRoot.class.getConstructors();
    ...
    void shouldExposePublicFactoryMethod() throws NoSuchMethodException {
        Method factoryMethod =
                TestAggregateRoot.class.getDeclaredMethod(
                        "create",
                        String.class
                );
        ...
        assertThat(factoryMethod.getReturnType())
                .isEqualTo(TestAggregateRoot.class);
    }
