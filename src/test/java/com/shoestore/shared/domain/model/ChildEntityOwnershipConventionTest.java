...
class ChildEntityOwnershipConventionTest {
    ...
    void shouldNotExposePublicConstructorsForChildEntity() {
        Constructor<?>[] publicConstructors =
                TestChildEntity.class.getConstructors();
    ...
    void shouldKeepChildFactoryPackagePrivate() throws NoSuchMethodException {
        Method factoryMethod =
                TestChildEntity.class.getDeclaredMethod(
                        "create",
                        String.class
                );

        assertThat(Modifier.isPublic(factoryMethod.getModifiers()))
                .isFalse();

        assertThat(Modifier.isProtected(factoryMethod.getModifiers()))
                .isFalse();

        assertThat(Modifier.isPrivate(factoryMethod.getModifiers()))
                .isFalse();
    ...
    @Test
    void shouldKeepChildMutationMethodsNonPublic()
        ...
        assertThat(Modifier.isPublic(renameMethod.getModifiers()))
                .isFalse();
    }
    ...
    void shouldNotMarkChildEntityAsAggregateRoot() {
        assertThat(AggregateRoot.class.isAssignableFrom(
