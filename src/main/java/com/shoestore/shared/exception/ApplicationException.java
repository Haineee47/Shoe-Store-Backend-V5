 ...
 *
 * <p>This exception carries a structured {@link ErrorCode} that is translated into the standardized
 * API error response.
 */
public class ApplicationException extends RuntimeException {
  ...
  /**
   * Creates an exception using a contextual message while preserving the stable machine-readable
   * error code.
   */
