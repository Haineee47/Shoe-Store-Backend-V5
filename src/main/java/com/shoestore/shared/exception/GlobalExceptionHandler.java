 ...
 *
 * <p>
 * This handler translates framework-level and application-level exceptions
 * into the standardized {@link ErrorResponse} contract.
 * </p>
 *
 * <p>
 * Expected client and business errors are logged at {@code WARN} level.
 * Unexpected server errors are logged at {@code ERROR} level together with
 * their stack trace.
 * </p>
 */
...
public class GlobalExceptionHandler {
    ...
    private static final String VALIDATION_ERROR_CODE =
            "VALIDATION_FAILED";

    private static final String VALIDATION_ERROR_MESSAGE =
            "Request validation failed";

    private static final String MALFORMED_REQUEST_ERROR_CODE =
            "MALFORMED_REQUEST_BODY";

    private static final String MALFORMED_REQUEST_ERROR_MESSAGE =
            "Request body is missing or malformed";

    private static final String METHOD_NOT_ALLOWED_ERROR_CODE =
            "METHOD_NOT_ALLOWED";
    ...
    private static final String DEFAULT_FIELD_ERROR_MESSAGE =
            "Invalid value";

    private final ApplicationLogger logger;

    /**
     * Creates the global exception handler using the standard application
     ...
     *
     * <p>
     * Package-private visibility allows tests in the same package to inject
     * a mock logger without exposing test-specific construction publicly.
     * </p>
     *
    ...
    /**
     * Handles Bean Validation failures raised by request bodies annotated
     * with {@code @Valid}.
     *
     ...
     *
     * <p>
     * The original exception message is intentionally not exposed because it
     * may contain implementation details or sensitive information.
     * </p>
     *
