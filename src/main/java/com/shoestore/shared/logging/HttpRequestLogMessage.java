...
/**
 * Represents the information written to the application log after an HTTP request has completed.
 *
 ...
 */
public record HttpRequestLogMessage(String method, String path, int status, long durationMs) {
  ...
  public String format() {
    String template = status >= 500 ? FAILED_TEMPLATE : COMPLETED_TEMPLATE;
