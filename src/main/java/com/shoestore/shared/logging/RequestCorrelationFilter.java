 ...
 *
 * <p>The request identifier is added to the SLF4J MDC so that all log
 * entries produced while processing the request can include the same
 * correlation value.</p>
 */
@Component
public class RequestCorrelationFilter extends OncePerRequestFilter {
    ...
    private String resolveRequestId(HttpServletRequest request) {
        String requestId =
                request.getHeader(LoggingConstants.REQUEST_ID_HEADER);
