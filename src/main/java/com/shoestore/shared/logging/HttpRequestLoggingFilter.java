 ...
 *
 * <p>The filter intentionally excludes request bodies, response bodies, headers and query
 * parameters to prevent sensitive information from being written to application logs.
 */
@Component
...
public class HttpRequestLoggingFilter extends OncePerRequestFilter {
  ...
  public HttpRequestLoggingFilter() {
    this.logger = ApplicationLoggerFactory.getLogger(HttpRequestLoggingFilter.class);
  }
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      HttpRequestLogMessage logMessage =
          new HttpRequestLogMessage(
              request.getMethod(), resolvePath(request), response.getStatus(), durationMs);
